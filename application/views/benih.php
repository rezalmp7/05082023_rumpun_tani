            ...
            <div class="col-12 m-0 p-5">
                <div class="col-12 m-0 p-5">
                    <div class="col-12 m-0 mt-5 p-0 search-produk">
                        <form method="GET" action="<?php echo base_url(); ?>benih">
                            ...
                            <div class="col-12 m-0 p-0 row">
                                <div class="col-auto p-3">
                                    <div class="col-12 m-0 rounded background-corousel"
                                        style="background-image: url(<?php echo base_url(); ?>assets/images/benih/<?php echo $value['gambar']; ?>); height: 230px; width: 350px;">
                                    </div>
                                </div>
