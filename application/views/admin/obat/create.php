                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Tambah Obat</h6>
                        ...
                        <div class="card">
                            <form method="POST" action="<?php echo base_url(); ?>admin/obat/store" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label">Gambar obat <small class="text-danger">[ jpg | jpeg | png ]</small></label>
                                        <input type="file" id="input_gambar_obat" name="gambar" class="filestyle" data-buttonname="btn-secondary" onChange='getoutput(this)' placeholder="Upload Gambar obat" required>
